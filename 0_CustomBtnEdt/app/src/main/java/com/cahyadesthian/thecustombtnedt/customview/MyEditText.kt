package com.cahyadesthian.thecustombtnedt.customview
...
import com.cahyadesthian.thecustombtnedt.R
...
class MyEditText: AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        ...
        /*
        * When there is change on edit text
        * show the clear
        * */
