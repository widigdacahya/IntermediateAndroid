...
class RandomNumberWidget : AppWidgetProvider() {
    ...
    private fun getPendingSelfIntent(context: Context, appWidgetId: Int, action:String) : PendingIntent {
        val intentPending = Intent(context, RandomNumberWidget::class.java)
        intentPending.action = action
        intentPending.putExtra(RandomNumberWidget.WIDGET_ID_EXTRA, appWidgetId)
        return PendingIntent.getBroadcast(context,appWidgetId,intentPending,
    ...
    internal fun updateAppWidget(
        ...
        /*
        * in order sequence after crewating getPendingSelfIntent and onReceive
        * */
