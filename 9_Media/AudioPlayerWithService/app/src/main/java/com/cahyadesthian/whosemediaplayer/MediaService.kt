...
class MediaService : Service(), MediaPlayerCallback {
    ...
    private fun showNotif() {
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_DEFAULT_IMPORTANCE)
            ...
            .setContentText("ContextText here \uD83D\uDCDA")
    ...
    companion object {
        const val ACTION_CREATE = "com.cahyadesthian.whosemediaplayer.mediaservice.create"
        const val ACTION_DESTROY = "com.cahyadesthian.whosemediaplayer.mediaservice.destroy"
