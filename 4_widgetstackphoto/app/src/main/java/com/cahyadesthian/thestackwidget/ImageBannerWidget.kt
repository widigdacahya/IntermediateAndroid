...
class ImageBannerWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        private val TOAST_ACTION = "com.cahyadesthian.thestackwidget.TOAST_ACTION"
        const val EXTRA_ITEM = "com.cahyadesthian.thestackwidget.EXTRA_ITEM"
        ...
        private fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ...
            views.setRemoteAdapter(R.id.stack_view_widgetApp, intent)
            views.setEmptyView(R.id.stack_view_widgetApp, R.id.empty_view_widgetApp)
            ...
            //views.setTextViewText(R, widgetText)
